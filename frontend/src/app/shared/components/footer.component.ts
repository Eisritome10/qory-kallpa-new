        ...
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p class="mt-3 text-sm text-marino-300">
              Voces con Poder. Promovemos, preservamos y revitalizamos las culturas y lenguas originarias de America Latina.
            </p>
          </div>

          <div>
            <h3 class="text-sm font-semibold uppercase tracking-wide text-naranja-400">Navegacion</h3>
          ...
          <div>
            <h3 class="text-sm font-semibold uppercase tracking-wide text-naranja-400">Siguenos</h3>
