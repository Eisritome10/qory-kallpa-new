    ...
    <section class="bg-white py-20">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div appReveal class="mx-auto max-w-2xl text-center">
          ...
          <h2 class="mt-2 text-3xl font-extrabold text-marino-900 sm:text-4xl">Las personas detrás de Qori Kallpa</h2>
          <p class="mt-3 text-marino-500">
            Pasa el cursor o toca una tarjeta para conocer más.
          </p>
        </div>

        <!-- Fundación / Dirección General -->
        <div appReveal class="mt-16">
          <h3 class="text-lg font-bold text-marino-900">Fundación y Dirección General</h3>
        ...
        <!-- Direcciones de área -->
        <div appReveal class="mt-16">
          <h3 class="text-lg font-bold text-marino-900">Direcciones de Área</h3>
